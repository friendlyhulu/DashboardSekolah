...
$query = "SELECT * FROM tabel_catatan where id_catatan=$id_catatan";
$hasil = mysqli_query($con, $query);
while ($note = mysqli_fetch_array($hasil)){
 ...
 if(isset($_POST['update'])){
     ...
     $query = "UPDATE tabel_catatan SET nama_siswa='$nama_siswa', catatan='$catatan' where id_catatan = $id_catatan";
     $proses = mysqli_query($con, $query);

     if ($proses) {
        echo '<br><div class="alert alert-primary" role="alert">Catatan berhasil diperbaharui- <a href="./catatan_wali.php" class="alert-link">Lihat Data Catatan</a></div>';
    } else {
...
<!-- Content --> 
    ...
    <div class="card text-white bg-dark mb-3"> &ensp;
        <h4 style="padding-left: 15px;"><b>  Edit Catatan</b></h4>
            <div class="card-header">Silahkan lengkapi form berikut untuk memperbaharui catatan</div>
        </div>
