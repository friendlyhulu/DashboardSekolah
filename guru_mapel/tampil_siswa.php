        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="../guru_mapel/tampil_siswa.php" class="nav__link active">
    ...
    <!-- TABEL SISWA -->
       <?php
            ...
            <!-- QUERY UNTUK MENAMPILKAN DAFTAR SISWA-->
                    ...
                    $sql = "SELECT * FROM tabel_siswa JOIN tabel_kelas ON tabel_siswa.id_kelas = tabel_kelas.id_kelas WHERE tabel_kelas.kelas = '$kelas'";
                    $hasil = mysqli_query($con, $sql) or trigger_error("Query Failed! SQL: $sql - Error: ".mysqli_error($con), E_USER_ERROR);
                        $no = 0;
